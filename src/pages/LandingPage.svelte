        ...
        <div class="carousel-item active">
          <div class="col-md-3" style="float:left">
            <div class="card mb-2">
              ...
              <div class="card-body">
                ...
                <a href="/" class="btn btn-dark">Profili Gör</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-3" style="float:left">
            <div class="card mb-2">
              <img
                class="card-img-top"
                src="https://grain.org/system/attachments/sources/000/005/238/med_large/Rene-e.png"
                alt="card-img-cap"
              />
              <div class="card-body">
          ...
          <div class="col-md-3" style="float:left">
            <div class="card mb-2">
              <img
                class="card-img-top"
                src="https://grain.org/system/attachments/sources/000/005/244/med_large/Ramon.png"
                alt="card-img-cap"
              />
              <div class="card-body">
                <h4 class="card-title">Card title</h4>
          ...
          <div class="col-md-3" style="float:left">
            <div class="card mb-2">
              <img
                class="card-img-top"
                src="https://grain.org/system/attachments/sources/000/005/245/med_large/Larissa.png"
                alt="card-img-cap"
              />
              <div class="card-body">
                <h4 class="card-title">Card title</h4>
          ...
          <div class="col-md-3" style="float:left">
            <div class="card mb-2">
              ...
              <div class="card-body">
                ...
                <a href="/" class="btn btn-primary">Profili Gör</a>
              </div>
            </div>
          </div>
